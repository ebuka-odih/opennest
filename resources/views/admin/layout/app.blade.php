                ...
                <ul class="nav-main">
                    ...
                    <li class="nav-main-item">
                        <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                            ...
                            <span class="nav-main-link-name">NFTListing</span>
                        </a>
                        <ul class="nav-main-submenu">
                            <li class="nav-main-item">
                    ...
                    <li class="nav-main-item">
                        <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                            <i class="nav-main-link-icon fa fa-images"></i>
                            <span class="nav-main-link-name">Collectables</span>
                        </a>
                        <ul class="nav-main-submenu">
                            <li class="nav-main-item">
                                <a class="nav-main-link" href="{{ route('admin.collectable.create') }}">
                                    <span class="nav-main-link-name">Add</span>
                                </a>
                            </li>
                            <li class="nav-main-item">
                                <a class="nav-main-link" href="{{ route('admin.collectable.index') }}">
