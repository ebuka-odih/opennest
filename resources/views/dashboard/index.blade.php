                ...
                <div class="nk-block-between-md g-4">
                    ...
                    <div class="nk-block-head-content">
                        <ul class="nk-block-tools gx-3">
                            ...
                            <li><a href="{{ route('user.buy') }}" class="btn btn-white btn-light"><span>Buy / Sell NFT</span> <em class="icon ni ni-arrow-long-right d-none d-sm-inline-block"></em></a></li>
                        </ul>
                    </div><!-- .nk-block-head-content -->
                        ...
                        <div class="nk-refwg-stats card-inner bg-lighter">
                            <div class="nk-refwg-group g-3">
                                <div class="nk-refwg-name">
                                    <h6 class="title"> <em class="icon ni ni-info" data-toggle="tooltip" data-placement="right" title="Referral Informations"></em></h6>
                                </div>
